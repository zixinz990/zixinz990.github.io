...
I've also come to realize that my mindset might be holding me back. If a tool offers a real boost in productivity, why fight it? At the end of the day, coding is basically just a tool roboticists use to create new silicon-based life, right? On a personal level, enjoying the process of writing code by hand is definitely important, but it shouldn't be at the top of the priority list. So, even though I'm still wrapping my head around the shock of 'vibe coding,' I've made my peace with it. I might have been forced into it a little bit, but when you look at the bigger picture, none of that really matters.

Every new technology has its fair share of unreliability when it first comes out, but over the years, those holes will get patched up one by one. I belive that if I resist this AI revolution now, I'm basically just like the carriage driver back in the early 1900s, trying to race a car with a horse. I'll just end up looking ridiculous. The wave of technological progress never stops. Refusing to adapt just means you're going to get left in the dust.